...
void CPlayer::Render(HDC hDC)
{
	...
	if (m_Dir == true)
	{
		...
		Ellipse(hDC, m_tRect.left + iScrollX - 20, m_tRect.top + 40, m_tRect.right + iScrollX - 30, m_tRect.bottom + 35);//øﬁπﬂ
		Ellipse(hDC, m_tRect.left + iScrollX + 30, m_tRect.top + 40, m_tRect.right + iScrollX + 30, m_tRect.bottom + 20);//ø¿∏•πﬂ
		Ellipse(hDC, m_tRect.left + iScrollX + 40, m_tRect.top + 10, m_tRect.right + iScrollX + 20, m_tRect.bottom - 10);//ø¿∏•∆»
		Rectangle(hDC, m_tRect.left + iScrollX, m_tRect.top, m_tRect.right + iScrollX, m_tRect.bottom);//∏ˆ≈Î
		Ellipse(hDC, m_tRect.left + iScrollX - 15, m_tRect.top - 60, m_tRect.right + iScrollX + 15, m_tRect.bottom - 30);//∏”∏Æ
		Ellipse(hDC, m_tRect.left + iScrollX - 20, m_tRect.top + 10, m_tRect.right + iScrollX - 40, m_tRect.bottom - 10);//øﬁ∆»
	    //ø¿∏•¬ ¿Ãµø ∑£¥ı
	}
	if (m_Dir == false)
	{
		...
		Ellipse(hDC, m_tRect.left + iScrollX - 30, m_tRect.top + 40, m_tRect.right + iScrollX - 30, m_tRect.bottom + 20);//øﬁπﬂ
		Ellipse(hDC, m_tRect.left + iScrollX + 30, m_tRect.top + 40, m_tRect.right + iScrollX + 20, m_tRect.bottom + 35);//ø¿∏•πﬂ
		Ellipse(hDC, m_tRect.left + iScrollX - 20, m_tRect.top + 10, m_tRect.right + iScrollX - 40, m_tRect.bottom - 10);//øﬁ∆»
		Rectangle(hDC, m_tRect.left + iScrollX, m_tRect.top, m_tRect.right + iScrollX, m_tRect.bottom);//∏ˆ≈Î
		Ellipse(hDC, m_tRect.left + iScrollX - 15, m_tRect.top - 60, m_tRect.right + iScrollX + 15, m_tRect.bottom - 30);//∏”∏Æ
		Ellipse(hDC, m_tRect.left + iScrollX + 40, m_tRect.top + 10, m_tRect.right + iScrollX + 20, m_tRect.bottom - 10);//ø¿∏•∆»
